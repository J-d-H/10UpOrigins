...
public class SpritesPanel extends JPanel implements MouseListener, MouseMotionListener {
	...
	private SpritesPanel() {
		int i = 0;
		sprites.add(new Sprite("../Assets/sprites/0.png", i++));
		sprites.add(new Sprite("../Assets/sprites/1.png", i++));
		sprites.add(new Sprite("../Assets/sprites/2.png", i++));
		sprites.add(new Sprite("../Assets/sprites/3.png", i++));
		sprites.add(new Sprite("../Assets/sprites/4.png", i++));
		sprites.add(new Sprite("../Assets/sprites/5.png", i++));
		sprites.add(new Sprite("../Assets/sprites/6.png", i++));
		sprites.add(new Sprite("../Assets/sprites/7.png", i++));
		sprites.add(new Sprite("../Assets/sprites/8.png", i++));
		sprites.add(new Sprite("../Assets/sprites/9.png", i++));
